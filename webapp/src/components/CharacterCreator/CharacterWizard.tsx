    ...
    return (
        <div className="flex flex-col gap-8 w-full max-w-7xl mx-auto px-4">
            ...
            <div className="relative group">
                ...
                <div className={`h-fit max-h-[75vh] glass-card p-8 rounded-[40px] border border-white/5 relative bg-[#18181b]/30 backdrop-blur-3xl shadow-2xl transition-all duration-500 w-full flex flex-col items-center justify-center ${isGenerating ? 'snake-active' : ''}`}>
